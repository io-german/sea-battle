...
case object ArrangementStartNotification extends ServerMessage("arrangement_start_notification")
case object GameStartNotification extends ServerMessage("game_start_notification")
case object YourTurnNotification extends ServerMessage("your_turn_notification")
case class GameOverNotification(winner: String) extends ServerMessage("game_over_notification")
